...
Opaque roundStepEqb isSome maybeGet .
...
(*     Opaque eqb. *)
    ...
    Transparent maybeGet .
    setoid_rewrite H3 in H5. idtac.
    discriminate. idtac.
    Transparent isSome. compute in H4. discriminate. idtac.
    setoid_rewrite H3 in H5. discriminate. idtac.
    setoid_rewrite H3 in H4. discriminate. idtac.
    setoid_rewrite H3 in H5. discriminate. idtac.
    compute in H4. discriminate. idtac.
    compute in H4. discriminate. idtac.
    setoid_rewrite H3 in H4. discriminate. idtac.
    setoid_rewrite H4 in H6. discriminate. idtac.
    setoid_rewrite H5 in H6. discriminate. idtac.
    compute in H5. discriminate. idtac.
    setoid_rewrite H4 in H5. discriminate. 
Qed.    

Transparent  isSome maybeGet .
Opaque roundStepEqb.
